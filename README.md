<!--
 license: Copyright 2016, Stichting Kennisnet
 ...
 * Java 8
 * IntelliJ IDEA 15 - Ontwikkelomgeving
  * Maven 3.0.5 (bundled) - Build tool
 ...
 * **n.k.n.c/AbstractTest.java**: Basis Class voor het initializeren van de SchoolIDServiceUtil instance. Daarnaast bevat deze class diverse variabelen die als input dienen voor de testen. Alle UnitTest classes erven over van de AbstractUnitTest class.
 ...
 * **n.k.n.c/ReplaceEckIdOperationTest.java**: Voorbeeldcode voor het uitvoeren van een Replace ECK ID Operation: het vervangen van een nieuwe HPGN door een reeds bestaande HPGN om zodoende het reeds uitgegeven ECK ID te kunnen blijven gebruiken in de keten bij een PGN/BSN wijziging.
 ...
 * **n.k.n.c/RetrieveEckIdOperationTest.java**: Voorbeeldcode voor het uitvoeren van een Retrieve Eck ID Operation: het ophalen van een enkele ECK ID in de Nummervoorziening applicatie op basis van een eerste niveau hash, keten id en sector id.
